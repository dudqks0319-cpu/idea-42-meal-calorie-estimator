...
import 'package:app_42_meal_calorie_estimator/app.dart';
import 'package:app_42_meal_calorie_estimator/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('식단사진 칼로리 추정'), findsWidgets);
